...
// NOTA: most of code from Xamarin-Forms-Labs
/// /////////////////////////////////////////
...
namespace App3.Shared.DI
{
	...
	public interface IDependencyContainer
	{
		...
		/// <typeparam name="TImpl">Type to register for instantiation.</typeparam>
		/// <returns>An instance of <see cref="IDependencyContainer"/></returns>
		IDependencyContainer RegisterAsSingleton<T, TImpl>()
			where T : class
			where TImpl : class, T;
		...
		/// <summary>
		/// Tries to register a type as singleton
		/// </summary>
		/// <param name="type">Type to register.</param>
		/// <param name="impl">Type that implements registered type.</param>
		/// <returns>An instance of <see cref="IDependencyContainer"/></returns>
		IDependencyContainer RegisterAsSingleton(Type type, Type impl);
		...
		/// <param name="impl">Type that implements registered type.</param>
		/// <returns>An instance of <see cref="IDependencyContainer"/></returns>
		IDependencyContainer RegisterAsMultiInstance(Type type, Type impl);
